/**
* numberoftimes.c: The program explores the time that it takes (on average) to allocate 
* a certain amount of memory over time to see if the time of a memory management call 
* changes with the number of allocation and free operations the program has executed.
*
* Scottie YANG Miaoyi
* Apr 28, 2022
*/
...
int main(int argc, char *argv[])
{
    ...
    if( argc == 2 ) {
        ...
        printf("Please enter the size of the malloc in bytes in command-line.\n");
        exit(-1);
    }
